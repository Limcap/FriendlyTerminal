...
namespace Limcap.UTerminal {
	internal class ParameterTypeAssistant_optm0 {

		public ParameterTypeAssistant_optm0( Dictionary<string, Type> commandsSet, string locale ) {
		...
		internal List<string> GetAutocompleteOtions_Unoptimal( string fullInput ) {
		...
		private ValueTuple<string, string> SplitInput( string input ) {
